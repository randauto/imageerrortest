...
public final class C0171a extends RuntimeException {
    ...
    /* renamed from: a */
    private final List<Throwable> f367a;

    /* renamed from: b */
    private final String f368b;

    /* renamed from: c */
    private Throwable f369c;
    ...
    static abstract class C0173b {
        ...
        /* renamed from: a */
        public abstract void mo374a(Object obj);
    ...
    static final class C0174c extends C0173b {
        ...
        /* renamed from: a */
        private final PrintStream f370a;

        C0174c(PrintStream printStream) {
            this.f370a = printStream;
        }

        /* access modifiers changed from: 0000 */
        /* renamed from: a */
        public void mo374a(Object obj) {
            this.f370a.println(obj);
        }
    }
    ...
    static final class C0175d extends C0173b {
        ...
        /* renamed from: a */
        private final PrintWriter f371a;

        C0175d(PrintWriter printWriter) {
            this.f371a = printWriter;
        }

        /* access modifiers changed from: 0000 */
        /* renamed from: a */
        public void mo374a(Object obj) {
            this.f371a.println(obj);
        }
    }

    public C0171a(Throwable... thArr) {
    ...
    public C0171a(Iterable<? extends Throwable> iterable) {
        ...
        if (iterable != null) {
            for (Throwable th : iterable) {
                if (th instanceof C0171a) {
                    linkedHashSet.addAll(((C0171a) th).mo367a());
                } else if (th != null) {
        ...
        if (!linkedHashSet.isEmpty()) {
            ...
            sb.append(this.f367a.size());
            sb.append(" exceptions occurred. ");
            this.f368b = sb.toString();
            return;
        }
    ...
    public synchronized java.lang.Throwable getCause() {
        /*
            r8 = this;
            monitor-enter(r8)
            java.lang.Throwable r0 = r8.f369c     // Catch:{ all -> 0x0060 }
            ...
            java.util.List<java.lang.Throwable> r2 = r8.f367a     // Catch:{ all -> 0x0060 }
        ...
        L_0x0029:
            ...
            java.util.List r5 = r8.m489a(r4)     // Catch:{ all -> 0x0060 }
        ...
        L_0x0055:
            java.lang.Throwable r3 = r8.m492b(r3)     // Catch:{ all -> 0x0060 }
            goto L_0x0016
        L_0x005a:
            r8.f369c = r0     // Catch:{ all -> 0x0060 }
        L_0x005c:
            java.lang.Throwable r0 = r8.f369c     // Catch:{ all -> 0x0060 }
            monitor-exit(r8)
            return r0
    ...
    public void printStackTrace(PrintStream printStream) {
        m490a((C0173b) new C0174c(printStream));
    }

    public void printStackTrace(PrintWriter printWriter) {
        m490a((C0173b) new C0175d(printWriter));
    }

    /* renamed from: a */
    private void m490a(C0173b bVar) {
        ...
        bVar.mo374a(sb.toString());
    }

    /* renamed from: a */
    private void m491a(StringBuilder sb, Throwable th, String str) {
        StackTraceElement[] stackTrace;
        sb.append(str);
        sb.append(th);
        sb.append(10);
        ...
        if (th.getCause() != null) {
            sb.append("\tCaused by: ");
            m491a(sb, th.getCause(), "");
        }
    }

    /* renamed from: a */
    private List<Throwable> m489a(Throwable th) {
        ArrayList arrayList = new ArrayList();
    ...
    /* renamed from: b */
    private Throwable m492b(Throwable th) {
        Throwable cause = th.getCause();
        if (cause == null || this.f369c == cause) {
            return th;
        }
        while (true) {
            Throwable cause2 = cause.getCause();
