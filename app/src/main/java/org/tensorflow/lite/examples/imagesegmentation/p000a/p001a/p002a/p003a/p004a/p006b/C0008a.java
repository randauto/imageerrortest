...
public abstract class C0008a {
    ...
    protected final C0151i kit;
    private final C0094c method;
    private final String protocolAndHostOverride;
    private final C0103e requestFactory;
    private final String url;

    public C0008a(C0151i iVar, String str, String str2, C0103e eVar, C0094c cVar) {
        if (str2 == null) {
    ...
    /* access modifiers changed from: protected */
    public C0095d getHttpRequest() {
        return getHttpRequest(Collections.emptyMap());
    }

    /* access modifiers changed from: protected */
    public C0095d getHttpRequest(Map<String, String> map) {
        C0095d a = this.requestFactory.mo197a(this.method, getUrl(), map).mo210a(false).mo200a((int) DEFAULT_TIMEOUT);
        String str = HEADER_USER_AGENT;
        StringBuilder sb = new StringBuilder();
        sb.append(CRASHLYTICS_USER_AGENT);
        sb.append(this.kit.getVersion());
        return a.mo203a(str, sb.toString()).mo203a(HEADER_DEVELOPER_TOKEN, CLS_ANDROID_SDK_DEVELOPER_TOKEN);
    }
