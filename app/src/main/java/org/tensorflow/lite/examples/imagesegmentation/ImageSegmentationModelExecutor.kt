...
class ImageSegmentationModelExecutor(
    ...
    fun execute(data: Bitmap): ModelExecutionResult {
        try {
            ...
            // Scale anh da chup de co kich thuoc nho hop ly.
            val scaledBitmap =
            ...
            // su dung interpreter de chuyen byte buffer ảnh bên trên về segmentation masks theo model đã có.
...
//        private const val imageSegmentationModel = "deeplabv3_257_mv_gpu.tflite"
        private const val imageSegmentationModel = "data_513.pb"
