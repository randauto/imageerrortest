...
class C0013e implements C0017f {
    ...
    private static final class C0015a implements ServiceConnection {
        ...
        public IBinder mo33a() {
            if (this.f16a) {
                C0140c.m397g().mo292e("Fabric", "getBinder already called");
            }
            this.f16a = true;
            try {
                return (IBinder) this.f17b.poll(200, TimeUnit.MILLISECONDS);
            } catch (InterruptedException unused) {
                return null;
            }
        }
    ...
    private static final class C0016b implements IInterface {
        ...
        /* JADX INFO: used method not loaded: a.a.a.a.l.a(java.lang.String, java.lang.String):null, types can be incorrect */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:?, code lost:
            p000a.p001a.p002a.p003a.C0140c.m397g().mo283a("Fabric", "Could not get parcel from Google Play Service to capture AdvertisingId");
         */
        ...
        public java.lang.String mo36a() {
            ...
            L_0x0022:
                ...
                goto L_0x0037
            L_0x0024:
                a.a.a.a.l r2 = p000a.p001a.p002a.p003a.C0140c.m397g()     // Catch:{ all -> 0x0022 }
                java.lang.String r3 = "Fabric"
                java.lang.String r4 = "Could not get parcel from Google Play Service to capture AdvertisingId"
                r2.mo283a(r3, r4)     // Catch:{ all -> 0x0022 }
                r1.recycle()
                r0.recycle()
                r2 = 0
            L_0x0036:
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
            p000a.p001a.p002a.p003a.C0140c.m397g().mo283a("Fabric", "Could not get parcel from Google Play Service to capture Advertising limitAdTracking");
         */
        /* JADX WARNING: Failed to process nested try/catch */
        ...
        public boolean mo38b() {
            ...
            L_0x0023:
                ...
                goto L_0x0037
            L_0x0025:
                a.a.a.a.l r3 = p000a.p001a.p002a.p003a.C0140c.m397g()     // Catch:{ all -> 0x0023 }
                ...
                r3.mo283a(r4, r5)     // Catch:{ all -> 0x0023 }
            L_0x0030:
                r1.recycle()
                r0.recycle()
                return r2
    ...
    public C0009b mo31a() {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            C0140c.m397g().mo283a("Fabric", "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            ...
            try {
                if (this.f15a.bindService(intent, aVar, 1)) {
                    try {
                        ...
                        C0140c.m397g().mo291d("Fabric", "Exception in binding to Google Play Service to capture AdvertisingId", e);
                        this.f15a.unbindService(aVar);
                    }
                } else {
                    C0140c.m397g().mo283a("Fabric", "Could not bind to Google Play Service to capture AdvertisingId");
                    return null;
                }
            } catch (Throwable th) {
                C0140c.m397g().mo284a("Fabric", "Could not bind to Google Play Service to capture AdvertisingId", th);
            }
        } catch (NameNotFoundException unused) {
            C0140c.m397g().mo283a("Fabric", "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e2) {
            C0140c.m397g().mo284a("Fabric", "Unable to determine if Google Play Services is available", (Throwable) e2);
            return null;
        }
    }
}
